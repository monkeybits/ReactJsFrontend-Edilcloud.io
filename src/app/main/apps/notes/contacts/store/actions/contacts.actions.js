...
export const GET_CONTACTS = '[CONTACTS APP] GET CONTACTS (PROJECT)';
export const FILTER_BY = '[CONTACTS APP] FILTER BY (PROJECT)';
export const FILTER_BY_KEY = '[CONTACTS APP] ADD FILTER KEY (PROJECT)';
export const RESET_CONTACTS = '[CONTACTS APP] RESET CONTACTS (PROJECT)';
export const GET_WAITING_CONTACTS = '[CONTACTS APP] GET WAITING CONTACTS (PROJECT)';
export const GET_DEACTIVATED_CONTACTS = '[CONTACTS APP] GET DEACTIVATED CONTACTS (PROJECT)';
export const GET_REFUSED_CONTACTS = '[CONTACTS APP] GET REFUSED CONTACTS (PROJECT)';
export const SET_SEARCH_TEXT = '[CONTACTS APP] SET SEARCH TEXT (PROJECT)';
export const OPEN_NEW_CONTACT_DIALOG = '[CONTACTS APP] OPEN NEW CONTACT DIALOG (PROJECT)';
export const CLOSE_NEW_CONTACT_DIALOG = '[CONTACTS APP] CLOSE NEW CONTACT DIALOG (PROJECT)';
export const OPEN_EDIT_CONTACT_DIALOG = '[CONTACTS APP] OPEN EDIT CONTACT DIALOG (PROJECT)';
export const OPEN_VIEW_CONTACT_DIALOG = '[CONTACTS APP] OPEN VIEW CONTACT DIALOG (PROJECT)';
export const CLOSE_EDIT_CONTACT_DIALOG = '[CONTACTS APP] CLOSE EDIT CONTACT DIALOG (PROJECT)';
export const CLOSE_VIEW_CONTACT_DIALOG = '[CONTACTS APP] CLOSE VIEW CONTACT DIALOG (PROJECT)';
export const ADD_CONTACT = '[CONTACTS APP] ADD CONTACT (PROJECT)';
export const UPDATE_CONTACT = '[CONTACTS APP] UPDATE CONTACT (PROJECT)';
export const REMOVE_CONTACT = '[CONTACTS APP] REMOVE CONTACT (PROJECT)';
export const REMOVE_CONTACTS = '[CONTACTS APP] REMOVE CONTACTS (PROJECT)';
export const TOGGLE_STARRED_CONTACT = '[CONTACTS APP] TOGGLE STARRED CONTACT (PROJECT)';
export const TOGGLE_STARRED_CONTACTS = '[CONTACTS APP] TOGGLE STARRED CONTACTS (PROJECT)';
export const SET_CONTACTS_STARRED = '[CONTACTS APP] SET CONTACTS STARRED (PROJECT)';
