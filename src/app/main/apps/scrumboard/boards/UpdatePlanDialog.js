	...
	return (
		...
		>
			<DialogContent dividers>
                ...
                <Typography className="text-4xl font-bold text-center mt-12">
                    Upgrade to Standard
                </Typography>
                <div>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="ml-16">
                            <ListItem className="grid ">
                                <Typography className="text-18 p-4 flex items-center"><Icon className="mr-8">fiber_manual_record_rounded</Icon> Plan your work in one visual timeline.</Typography>
                                <Typography className="text-18 p-4 flex items-center"><Icon className="mr-8">fiber_manual_record_rounded</Icon>Share boards with people outside your team.</Typography>
                                <Typography className="text-18 p-4 flex items-center"><Icon className="mr-8">fiber_manual_record_rounded</Icon>Filter your boards however you choose.</Typography>
                                <Typography className="text-18 p-4 flex items-center"><Icon className="mr-8">fiber_manual_record_rounded</Icon>Send emails directly to add updates.</Typography>
                                <Typography className="text-18 p-4 flex items-center"><Icon className="mr-8">fiber_manual_record_rounded</Icon>Connect dapulse with your other apps</Typography>
                            </ListItem>
                        </div>
                    </div>
                    <div className="flex mt-24 justify-between">
                        <div className="grid justify-start">
                            ...
                            <Typography className="text-base">
                                you can supercharge your team's productivity.
                            </Typography>
