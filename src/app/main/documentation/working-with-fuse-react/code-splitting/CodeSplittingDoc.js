			...
			content={
				<div className="p-24 max-w-2xl">
					<Typography className="mb-16" component="p">
						Code-splitting your app can help you “lazy-load” just the things that are currently needed by
						the user, which can dramatically improve the performance of your app. While you haven’t reduced
					...
					<Typography className="mb-16" component="p">
						...
						<br />
						<b>FuseSuspense</b> component is created for to avoid repetition of <b>React.Suspense</b>
                                ...
                                routes  : [
                                    {
                                        ...
                                        component: loadable(() => import('./AnalyticsDashboardApp'))
                                    }
                                ]
                            };
                            `}
