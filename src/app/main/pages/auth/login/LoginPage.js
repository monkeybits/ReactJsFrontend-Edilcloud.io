					...
					<Card className="w-full">
						<CardContent className="flex flex-col items-center justify-center p-20 sm:p-32">
							...
							<Grid container spacing={2}>
								<Grid item xs={6}>
									<Button variant="outlined" color="primary" size="large" className="border-1 normal-case w-full">
										<img src="assets/images/social-icons/facebook.png" className="h-20 mr-8" alt="Facebook" />
										Facebook
									</Button>
								</Grid>
								<Grid item xs={6}>
							...
							<div className="my-28 flex items-center justify-center or-container">
								...
								<span className="mx-8 font-size-16 whitespace-no-wrap text-muted">Or sign in with email</span>
								<Divider className="w-full" />
							</div>
